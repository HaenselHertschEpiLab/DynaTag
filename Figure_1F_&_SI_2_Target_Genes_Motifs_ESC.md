# Figure_1_F_and_SI_2_-_Target_Genes_Motifs_ESC
## Tornado plots of NANOG, SOX2 and OCT4 target genes using matched ESC DynaTag, CUT&RUN and ChIP-seq data sets.
```bash
...
```
# HOMER2 known motif analyses NANOG, SOX2 and OCT4 using matched ESC ATAC-seq, DynaTag, CUT&RUN and ChIP-seq data sets.
```bash
...
```
## Tornado plots of NANOG, SOX2, OCT4, MYC and YAP1 using ESC DynaTag
```bash
