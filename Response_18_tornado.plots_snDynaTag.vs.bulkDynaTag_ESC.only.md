# Response_18
## Response Fig. 4a: Tornado plots of ESC and EpiLC TF bulk DynaTag occupancy - known ChIP-seq peaks
```bash
# Generation of differntial occupied regions by edgeR mm10 --> PEAKS_DIR="/scratch/rhaensel/DynaTag/ESC_EpiLC_DynaTag/edgeR/mm10_edgeR_ChIPseq_peaks"
...
# RHH reproduces Pascal's Differential Binding Analysis mm10 ChIP-Atlas peaks edgeR DynaTag
## Load Packages
library(edgeR)
library(ggplot2)
library(dplyr)
...
```
## Response Fig. 4b: Tornado plots of ESC and EpiLC TF bulk DynaTag occupancy - DynaTag peaks
```bash
